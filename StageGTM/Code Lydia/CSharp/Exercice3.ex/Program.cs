...
namespace Exercice3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            places[0].Pieces.Add(new Piece { Nom = "piece2€", taille = 3 });
            places[0].Pieces.Add(new Piece { Nom = "piece1€", taille = 2 });
            places[0].Pieces.Add(new Piece { Nom = "piece20c", taille = 1 });
    ...
    class Jeu
    {
        public void Deplacer(Emplacement initial, Emplacement objectif, Emplacement intermediaire)
        {
            ...
            {
                Console.WriteLine("{0}{1}{2}", initial.Pieces[0].taille, initial.Nom, objectif.Nom);
                objectif.Pieces.Add(initial.Pieces[0]);
                initial.Pieces.Remove(initial.Pieces[0]);
            }
            else
            {
